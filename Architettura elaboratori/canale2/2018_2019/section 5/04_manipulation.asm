...
# Scrivere un programma in linguaggio assembly MARS che legga una stringa introdotta da tastiera. 
# La stringa contiene sia caratteri maiuscoli che caratteri minuscoli,
